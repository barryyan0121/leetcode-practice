...
if __name__ == "__main__":
    s = Solution()
    assert s.validCoupons(["SAVE20", "", "PHARMA5", "SAVE@20"], ["restaurant", "grocery", "pharmacy", "restaurant"], [True, True, True, True]) == ["PHARMA5", "SAVE20"]
    assert s.validCoupons(["GROCERY15", "ELECTRONICS_50", "DISCOUNT10"], ["grocery", "electronics", "invalid"], [False, True, True]) == ["ELECTRONICS_50"]
    print("3606 ok")
